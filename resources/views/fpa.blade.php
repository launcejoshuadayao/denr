        ...
        <div class="table-container">
            ...
            <table class="table" id="tables">
                ...
                <tbody>
                    @if($fpadata->isEmpty())
                        <tr>
                            <td colspan="9" style="text-align: center; opacity: 0.5; padding: 20px;">
                                <div >
                    ...
                    @else
                        @foreach($fpadata as $fpa)
                            <tr>
                                ...
                                <td>
                                    <div class="actions">
                                        <button class="edit-btn" data-id="{{ $fpa->id_fpa }}"
                                            data-applicant_name="{{ $fpa->applicant_name }}"
                                            data-applicant_number="{{ $fpa->applicant_number }}"
                                            data-reffered_investigator="{{ $fpa->reffered_investigator }}"
                                            data-patented_subsisting="{{ $fpa->patented_subsisting }}"
                                            data-location="{{ $fpa->location }}" data-survey_no="{{ $fpa->survey_no }}"
                ...
                <form action="" class="form-containerEdit" id="editForm" method="POST">
                    ...
                    <script>
                        ...
                        function openFormEdit(button) {
                            ...
                            document.getElementById("editForm").action = "{{ route('updatefpa', '') }}/" + button.getAttribute("data-id");
